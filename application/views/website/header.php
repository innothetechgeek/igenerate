...
<div class="header" id="home">
	<div class="container">
		<ul>
		<li> <a href="<?php echo base_url();?>clients" aria-hidden="true"></i> Sign In </a></li>
			<li> <a href="<?php echo base_url();?>authentication/agent_signup"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sign Up </a></li>
